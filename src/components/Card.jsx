...
const Card = (props) => {
    return(
        <div className="flex-1 flex flex-nowrap flex-row p-2 mx-2 mt-2 bg-gray-700 rounded-xl h-full items-center cursor-pointer hover:bg-gray-600" onClick={() => props.onClick()}>
